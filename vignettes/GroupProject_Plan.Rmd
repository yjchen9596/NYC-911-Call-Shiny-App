...
#### Proposed data sources: 
 ...
 - Primary source of data is https://data.cityofnewyork.us/Public-Safety/NYPD-Calls-for-Service-Year-to-Date-/n2zq-pubd
 - We are also planning to use data from census with {tidycensus}
...
We segmented certain tasks among the group, but we will work with each other if additional help is needed.
 ...
 - Concillia: Lit review, Shiny coding-map tab
